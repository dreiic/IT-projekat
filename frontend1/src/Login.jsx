    ...
    <div className="auth-container">
      <div className="auth-card">
        ...
        <div className="auth-footer">
          <button onClick={onForgot} style={{ background: "none", border: "none", color: "#a0a0a0", cursor: "pointer", fontSize: "13px", padding: 0 }}>
            Zaboravili ste lozinku?
          </button>
        </div>
        <div className="auth-footer">
          Nemate nalog?{" "}
          <button className="auth-link" onClick={onSwitch} style={{ background: "none", border: "none", padding: 0, cursor: "pointer" }}>
            Registrujte se
          </button>
        </div>
      </div>
